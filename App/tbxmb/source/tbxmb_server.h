...
extern "C"
{
   ...
   */
  typedef tTbxMbServerResult ( *tTbxMbServerReadInput )( tTbxMbServer channel, uint16_t addr,
                                                         uint8_t *value );
   ...
   *           TBX_MB_SERVER_ERR_DEVICE_FAILURE otherwise.
   */
  typedef tTbxMbServerResult ( *tTbxMbServerReadCoil )( tTbxMbServer channel, uint16_t addr,
                                                        uint8_t *value );
   ...
   *           TBX_MB_SERVER_ERR_DEVICE_FAILURE otherwise.
   */
  typedef tTbxMbServerResult ( *tTbxMbServerWriteCoil )( tTbxMbServer channel, uint16_t addr,
                                                         uint8_t value );
   ...
   *           TBX_MB_SERVER_ERR_DEVICE_FAILURE otherwise.
   */
  typedef tTbxMbServerResult ( *tTbxMbServerReadInputReg )( tTbxMbServer channel, uint16_t addr,
                                                            uint16_t *value );
   ...
   *           TBX_MB_SERVER_ERR_DEVICE_FAILURE otherwise.
   */
  typedef tTbxMbServerResult ( *tTbxMbServerReadHoldingReg )( tTbxMbServer channel, uint16_t addr,
                                                              uint16_t *value );
   ...
   *           TBX_MB_SERVER_ERR_DEVICE_FAILURE otherwise.
   */
  typedef tTbxMbServerResult ( *tTbxMbServerWriteHoldingReg )( tTbxMbServer channel, uint16_t addr,
                                                               uint16_t value );
   ...
   */
  typedef uint8_t ( *tTbxMbServerCustomFunction )( tTbxMbServer channel, uint8_t const *rxPdu,
